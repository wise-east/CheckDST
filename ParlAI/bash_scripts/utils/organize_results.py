...
if __name__ == "__main__":
    ...
    fps += glob(
        "/data/home/justincho/ParlAI/models/bart_all_pft_lr5e-6_eps10_ngpu8_bs8_2021-11-11_multiwoz2.3/fs_False_prompts_True_lr5e-05_bs4_uf1*"
    )
    fps += glob(
    ...
    fps += glob(
        "/data/home/justincho/ParlAI/models/bart_muppet_multiwoz2.3/fs_False_prompts_True_lr1e-04_bs4_uf1*"
    )
    fps += glob(
        "/data/home/justincho/ParlAI/models/bart_scratch_multiwoz2.1/fs_False_prompts_True_lr5e-05_bs8_uf1*"
    )
    fps += glob(
        "/data/home/justincho/ParlAI/models/bart_scratch_multiwoz2.1/fs_True_prompts_True_lr5e-05_bs4_uf1*"
    )
    fps += glob(
        "/data/home/justincho/ParlAI/models/bart_all_pft_lr5e-6_eps10_ngpu8_bs8_2021-11-11_multiwoz2.1/fs_False_prompts_True_lr1e-05_bs8_uf2*"
    )
    fps += glob(
    ...
    fps += glob(
        "/data/home/justincho/ParlAI/models/bart_muppet_multiwoz2.1/fs_False_prompts_True_lr1e-04_bs8_uf1*"
    )
    fps += glob(
