...
# # MFDIR="/data/home/justincho/ParlAI/models/test/"
# MFDIR="/data/home/justincho/ParlAI/models/test_pft/"
# # INIT_CMD="--init-model /data/home/justincho/ParlAI/data/models/bart/bart_large/model"
# INIT_CMD="--init-model /data/home/justincho/ParlAI/models/bart_all_pft/lr5e-6_eps10_ngpu8_bs8_2021-11-11_22:26:26/model"
...
parlai train_model \
    ...
    $INIT_CMD
"
    # --validation-every-n-epochs 1 --save-after-valid True --eval-batchsize 1 --validation-metric 'joint goal acc' --validation-metric-mode max --validation-patience 5 \


echo $CMD 
eval $CMD

# All of what used to be below has been put in with the arg `optimize_for_multiwoz`
