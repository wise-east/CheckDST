...
class TestDictionary(unittest.TestCase):
    ...
    def test_gpt2_bpe_tokenize(self):
        ...
        self.assertEqual(
            # grinning face emoji
            agent.gpt2_tokenize("Hello, ParlAI! \U0001f600"),
            GPT2_BPE_RESULT,
        )
        self.assertEqual(
            agent.vec2txt(agent.tok2ind[w] for w in GPT2_BPE_RESULT),
            # grinning face emoji
            "Hello, ParlAI! \U0001f600",
        )
...
class TestByteLevelBPE(unittest.TestCase):
    ...
    def test_tokenize_prefix_space(self):
        ...
        self.assertEqual(
            # grinning face emoji
            agent.bytelevelbpe_tokenize("Hello, ParlAI! \U0001f600"),
        ...
        self.assertEqual(
            agent.txt2vec("Hello, ParlAI! \U0001f600"),
...
class TestGpt2HFInterop(unittest.TestCase):
    ...
    def _run_test(self, slow_bytelevel_bpe, hf_bpe):
        ...
        self.assertEqual(
            # grinning face emoji
            slow_bytelevel_bpe.bytelevelbpe_tokenize("Hello, ParlAI! \U0001f600"),
            slow_bytelevel_bpe_RESULT,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            slow_bytelevel_bpe.txt2vec("Hello, ParlAI! \U0001f600"),
            [slow_bytelevel_bpe.tok2ind[w] for w in slow_bytelevel_bpe_RESULT],
        )
