...
train_dials_few_keys = list(
    np.random.choice(list(train_dials.keys()), int(len(train_dials) / 10))
)
...
os.system(
    "mv dialoglue/multiwoz/MULTIWOZ2.1_fewshot/train_dials_10.json dialoglue/multiwoz/MULTIWOZ2.1_fewshot/train_dials.json"
)
