...
def evaluate(test_annotation_file, user_annotation_file, phase_codename, **kwargs):
    ...
    for dataset, gt_outputs in gt_outputs.items():
        ...
        if phase_codename == "few":
            ...
            for i in range(5):
                ...
                if task == "intent" or task == "top":
                    ...
                    dataset_results.append(
                        sum(
                            p == t
                            for p, t in zip(gen_outputs.get(dataset)[i], gt_outputs)
                        )
                        / len(gt_outputs)
                    )
                elif task == "slot":
                    dataset_results.append(
                        evaluate_slot(gen_outputs.get(dataset)[i], gt_outputs)
                    )
                elif task == "dst":
            ...
            if task == "intent" or task == "top":
                # Calculate accuracy between generated and ground-truth
                results[dataset] = sum(
                    p == t for p, t in zip(gen_outputs.get(dataset), gt_outputs)
                ) / len(gt_outputs)
            elif task == "slot":
    ...
    results = {rename.get(key): value * 100 for key, value in results.items()}
    ...
    output = {
        "result": [{"test_split": results}],
        "submission_result": [results.get(e) for e in labels],
    }
    print(output)
    return output
...
mwoz_config = {
    ...
    "label_maps": {
        ...
        "east": ["eastern", "eastside", "eastend"],
        "west": ["western", "westside", "westend"],
        "south": ["southern", "southside", "southend"],
        "cheap": [
            "inexpensive",
            "lower price",
            "lower range",
        ...
        "0": ["zero"],
        "1": ["one", "just me", "for me", "myself", "alone", "me"],
        "2": ["two"],
        "3": ["three"],
        "4": ["four"],
        "5": ["five"],
        ...
        "boat": ["boating", "boats", "camboats"],
        "boating": ["boat", "boats", "camboats"],
        "camboats": ["boating", "boat", "boats"],
        "cinema": ["cinemas", "movie", "films", "film"],
        "college": ["colleges"],
        "concert": [
            "concert hall",
            "concert halls",
        ...
        "night club": ["night clubs", "nightclub", "nightclubs", "club", "clubs"],
        "park": ["parks"],
        "pool": ["swimming pool", "swimming", "pools", "swimmingpool", "water", "swim"],
        "sports": [
            "multiple sport",
            "multi sport",
            "multi sports",
        ...
        "swimming pool": ["swimming", "pool", "pools", "swimmingpool", "water", "swim"],
        "theater": ["theatre", "theatres", "theaters"],
        "theatre": ["theater", "theatres", "theaters"],
        "abbey pool and astroturf pitch": ["abbey pool and astroturf", "abbey pool"],
        "abbey pool and astroturf": ["abbey pool and astroturf pitch", "abbey pool"],
        "abbey pool": ["abbey pool and astroturf pitch", "abbey pool and astroturf"],
        "adc theatre": ["adc theater", "adc"],
        "adc": ["adc theatre", "adc theater"],
        "addenbrookes hospital": ["addenbrooke's hospital"],
        "cafe jello gallery": ["cafe jello"],
        ...
        "cambridge arts theatre": ["cambridge arts theater"],
        ...
        "the cambridge corn exchange": ["cambridge corn exchange"],
        "cambridge museum of technology": ["museum of technology"],
        "cambridge punter": ["the cambridge punter", "cambridge punters"],
        "cambridge punters": ["the cambridge punter", "cambridge punter"],
        "the cambridge punter": ["cambridge punter", "cambridge punters"],
        ...
        "cherry hinton village center": ["cherry hinton village centre"],
        "cherry hinton hall and grounds": ["cherry hinton hall"],
        "cherry hinton hall": ["cherry hinton hall and grounds"],
        "cherry hinton water play": ["cherry hinton water play park"],
        "cherry hinton water play park": ["cherry hinton water play"],
        "christ college": ["christ's college", "christs college"],
        "christs college": ["christ college", "christ's college"],
        "churchills college": ["churchill's college", "churchill college"],
        "cineworld cinema": ["cineworld"],
        "clair hall": ["clare hall"],
        "clare hall": ["clair hall"],
        ...
        "jesus green": ["jesus green outdoor pool"],
        ...
        "mumford theatre": ["mumford theater"],
        "museum of archaelogy": ["museum of archaeology"],
        ...
        "queens college": ["queens' college", "queen's college"],
        "riverboat georgina": ["riverboat"],
        "saint barnabas": ["saint barbabas press gallery"],
        "saint barnabas press gallery": ["saint barbabas"],
        "saint catharines college": ["saint catharine's college", "saint catharine's"],
        "saint johns college": [
        ...
        "soul tree nightclub": ["soul tree night club", "soul tree", "soultree"],
        "soultree": ["soul tree nightclub", "soul tree night club", "soul tree"],
        "the man on the moon": ["man on the moon"],
        "man on the moon": ["the man on the moon"],
        "the junction": ["junction theatre", "junction theater"],
        "junction theatre": ["the junction", "junction theater"],
        "old schools": ["old school"],
        "vue cinema": ["vue"],
        "wandlebury country park": ["the wandlebury"],
        "the wandlebury": ["wandlebury country park"],
        ...
        "williams art and antique": ["william's art and antique"],
        "alimentum": ["restaurant alimentum"],
        "restaurant alimentum": ["alimentum"],
        "bedouin": ["the bedouin"],
        "the bedouin": ["bedouin"],
        "bloomsbury restaurant": ["bloomsbury"],
        "cafe uno": ["caffe uno", "caffee uno"],
        "caffe uno": ["cafe uno", "caffee uno"],
        "caffee uno": ["cafe uno", "caffe uno"],
        "cambridge lodge restaurant": ["cambridge lodge"],
        "chiquito": ["chiquito restaurant bar", "chiquito restaurant"],
        "chiquito restaurant bar": ["chiquito restaurant", "chiquito"],
        "city stop restaurant": ["city stop"],
        "cityr": ["cityroomz"],
        "citiroomz": ["cityroomz"],
        "clowns cafe": ["clown's cafe"],
        "cow pizza kitchen and bar": ["the cow pizza kitchen and bar", "cow pizza"],
        "the cow pizza kitchen and bar": ["cow pizza kitchen and bar", "cow pizza"],
        ...
        "da vinci pizzeria": ["da vinci pizza", "da vinci"],
        ...
        "efes": ["efes restaurant"],
        "efes restaurant": ["efes"],
        "fitzbillies restaurant": ["fitzbillies"],
        "frankie and bennys": ["frankie and benny's"],
        "funky": ["funky fun house"],
        "funky fun house": ["funky"],
        "gardenia": ["the gardenia"],
        "the gardenia": ["gardenia"],
        "grafton hotel restaurant": ["the grafton hotel", "grafton hotel"],
        "the grafton hotel": ["grafton hotel restaurant", "grafton hotel"],
        "grafton hotel": ["grafton hotel restaurant", "the grafton hotel"],
        "hotel du vin and bistro": ["hotel du vin", "du vin"],
        "Kohinoor": ["kohinoor", "the kohinoor"],
        "kohinoor": ["the kohinoor"],
        "the kohinoor": ["kohinoor"],
        "lan hong house": ["lan hong", "ian hong house", "ian hong"],
        "ian hong": ["lan hong house", "lan hong", "ian hong house"],
        "lovel": ["the lovell lodge", "lovell lodge"],
        "lovell lodge": ["lovell"],
        "the lovell lodge": ["lovell lodge", "lovell"],
        "mahal of cambridge": ["mahal"],
        "mahal": ["mahal of cambridge"],
        "maharajah tandoori restaurant": ["maharajah tandoori"],
        "the maharajah tandoor": [
            "maharajah tandoori restaurant",
            "maharajah tandoori",
        ],
        "meze bar": ["meze bar restaurant", "the meze bar"],
        "meze bar restaurant": ["the meze bar", "meze bar"],
        "the meze bar": ["meze bar restaurant", "meze bar"],
        "michaelhouse cafe": ["michael house cafe"],
        "midsummer house restaurant": ["midsummer house"],
        "missing sock": ["the missing sock"],
        "the missing sock": ["missing sock"],
        "nandos": [
            "nando's city centre",
            "nando's city center",
            "nandos city centre",
        ...
        "one seven": ["restaurant one seven"],
        "restaurant one seven": ["one seven"],
        ...
        "pizza hut city centre": ["pizza hut city center"],
        "pizza hut fenditton": ["pizza hut fen ditton", "pizza express fen ditton"],
        "restaurant two two": ["two two", "restaurant 22"],
        "saffron brasserie": ["saffron"],
        "saint johns chop house": [
            "saint john's chop house",
            "st john's chop house",
            "st johns chop house",
        ],
        "sesame restaurant and bar": ["sesame restaurant", "sesame"],
        "shanghai": ["shanghai family restaurant"],
        "shanghai family restaurant": ["shanghai"],
        "sitar": ["sitar tandoori"],
        "sitar tandoori": ["sitar"],
        "slug and lettuce": ["the slug and lettuce"],
        "the slug and lettuce": ["slug and lettuce"],
        "st johns chop house": [
            "saint john's chop house",
            "st john's chop house",
            "saint johns chop house",
        ],
        "stazione restaurant and coffee bar": ["stazione restaurant", "stazione"],
        "thanh binh": ["thanh", "binh"],
        "thanh": ["thanh binh", "binh"],
        "binh": ["thanh binh", "thanh"],
        "the hotpot": ["the hotspot", "hotpot", "hotspot"],
        "hotpot": ["the hotpot", "the hotpot", "hotspot"],
        "the lucky star": ["lucky star"],
        "lucky star": ["the lucky star"],
        "the peking restaurant: ": ["peking restaurant"],
        "the varsity restaurant": ["varsity restaurant", "the varsity", "varsity"],
        "two two": ["restaurant two two", "restaurant 22"],
        "restaurant 22": ["restaurant two two", "two two"],
        "zizzi cambridge": ["zizzi"],
        "american": ["americas"],
        ...
        "corsica": ["corsican"],
        "indian": ["tandoori"],
        "italian": ["pizza", "pizzeria"],
        "japanese": ["sushi"],
        "latin american": ["latin-american", "latin"],
        "malaysian": ["malay"],
        "middle eastern": ["middle-eastern"],
        "traditional american": ["american"],
        "modern american": ["american modern", "american"],
        "modern european": ["european modern", "european"],
        "north american": ["north-american", "american"],
        "portuguese": ["portugese"],
        "portugese": ["portuguese"],
        "seafood": ["sea food"],
        "singaporean": ["singapore"],
        "steakhouse": ["steak house", "steak"],
        "the americas": ["american", "americas"],
        "a and b guest house": ["a & b guest house", "a and b", "a & b"],
        "the acorn guest house": ["acorn guest house", "acorn"],
        "acorn guest house": ["the acorn guest house", "acorn"],
        "alexander bed and breakfast": ["alexander"],
        "allenbell": ["the allenbell"],
        "the allenbell": ["allenbell"],
        "alpha-milton guest house": ["the alpha-milton", "alpha-milton"],
        "the alpha-milton": ["alpha-milton guest house", "alpha-milton"],
        "arbury lodge guest house": ["arbury lodge", "arbury"],
        "archway house": ["archway"],
        "ashley hotel": ["the ashley hotel", "ashley"],
        "the ashley hotel": ["ashley hotel", "ashley"],
        "aylesbray lodge guest house": ["aylesbray lodge", "aylesbray"],
        ...
        "cambridge belfry": ["the cambridge belfry", "belfry hotel", "belfry"],
        "the cambridge belfry": ["cambridge belfry", "belfry hotel", "belfry"],
        "belfry hotel": ["the cambridge belfry", "cambridge belfry", "belfry"],
        "carolina bed and breakfast": ["carolina"],
        "city centre north": ["city centre north bed and breakfast"],
        "north b and b": ["city centre north bed and breakfast"],
        "city centre north b and b": ["city centre north bed and breakfast"],
        ...
        "hamilton lodge": ["the hamilton lodge", "hamilton"],
        "the hamilton lodge": ["hamilton lodge", "hamilton"],
        "hobsons house": ["hobson's house", "hobson's"],
        ...
        "kirkwood": ["kirkwood house"],
        "kirkwood house": ["kirkwood"],
        "lensfield hotel": ["the lensfield hotel", "lensfield"],
        "the lensfield hotel": ["lensfield hotel", "lensfield"],
        "leverton house": ["leverton"],
        "marriot hotel": ["marriott hotel", "marriott"],
        "rosas bed and breakfast": ["rosa's bed and breakfast", "rosa's", "rosas"],
        "university arms hotel": ["university arms"],
        "warkworth house": ["warkworth hotel", "warkworth"],
        "warkworth hotel": ["warkworth house", "warkworth"],
        "wartworth": ["warkworth house", "warkworth hotel", "warkworth"],
        "worth house": ["the worth house"],
        "the worth house": ["worth house"],
        "birmingham new street": ["birmingham new street train station"],
        "birmingham new street train station": ["birmingham new street"],
        "bishops stortford": ["bishops stortford train station"],
        "bishops stortford train station": ["bishops stortford"],
        "broxbourne": ["broxbourne train station"],
        "broxbourne train station": ["broxbourne"],
        "cambridge": ["cambridge train station"],
        "cambridge train station": ["cambridge"],
        "ely": ["ely train station"],
        "ely train station": ["ely"],
        "kings lynn": [
            "king's lynn",
        ...
        "leicester": ["leicester train station"],
        "leicester train station": ["leicester"],
        "london kings cross": [
            "kings cross",
            "king's cross",
            "london king's cross",
        ...
        "norwich": ["norwich train station"],
        "norwich train station": ["norwich"],
        "peterborough": ["peterborough train station"],
        "peterborough train station": ["peterborough"],
        "stansted airport": ["stansted airport train station"],
        "stansted airport train station": ["stansted airport"],
        "stevenage": ["stevenage train station"],
        "stevenage train station": ["stevenage"],
    },
}
